CREATE DATABASE `nld_newscrawl_2016_10K`;

USE nld_newscrawl_2016_10K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=31187 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=9848 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'nld_newscrawl_2016_10K-sources.txt' INTO TABLE sources;
